...
void animation(void)
{
    ...
    x_angle = angles/1000;
    z_angle = angles%1000;
    zRotated = 0.9*zRotated+0.1*(190-x_angle);
    xRotated = 0.9*xRotated+0.1*(190-z_angle);
...
void reshape(int x, int y)
{
    ...
    float Ratio = (GLdouble)x/(GLdouble)y;

    glOrtho(Ratio*(-10), Ratio*4, (-5), 9, 2, 20);
    //gluPerspective(90.0,Ratio,1,30.0);
    glMatrixMode(GL_MODELVIEW);
